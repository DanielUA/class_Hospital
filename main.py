...
doctor_surg = Doctor("Bill", "Klinton", "Head_doctor")
doctor_tera = Doctor("Tom", "Jerry", "Therapist")

patient_one = Patient("George", "Bush", 1234567890)
patient_two = Patient("Barak", "Obama", 976543210)

doctor_surg.add(patient_one, "flu")
doctor_tera.add(patient_two, "appendicite")

print(patient_one.story["flu"].time)
print(patient_two.story["appendicite"].time)

doctor_surg.treat(patient_one, 'flu', 'pills')
doctor_tera.treat(patient_two, "appendicite", "operations")

print(patient_one.story['flu'].treatment)
print(patient_two.story["appendicite"].treatment)
